...
INSERT INTO tblMember VALUES
    (5, 1, 'Aidan', 'Ferguson', 'aidan.ferguson@example.com', '07801 123456', '1983-02-15', 'All', '2026-04-01'),
    (3, 2, 'Niamh', 'Doherty', 'niamh.doherty@example.com', '07801 123457', '1992-03-20', 'SGPT', '2026-04-01'),
    (2, 3, 'Connor', 'McBride', 'connor.mcbride@example.com', '07801 123458', '1995-04-30', 'HIIT&Hyrox', '2026-04-15'),
    (1, 4, 'Clodagh', 'Hughes', 'clodagh.hughes@example.com', '07801 123459', '1988-06-05', 'Boxing', '2026-04-10'),
    (4, 5, 'Ronan', 'Neill', 'ronan.neill@example.com', '07801 123460', '1990-08-22', 'All', '2026-04-01'),
    (5, 6, 'Sinead', 'Murray', 'sinead.murray@example.com', '07801 123461', '1994-05-14', 'SGPT', '2026-04-15'),
    (2, 7, 'Seamus', 'Boyle', 'seamus.boyle@example.com', '07801 123462', '1986-11-11', 'HIIT&Hyrox', '2026-05-10'),
    (2, 8, 'Fiona', 'Collins', 'fiona.collins@example.com', '07801 123463', '1991-02-21', 'Boxing', '2026-04-20'),
    (3, 9, 'Ethan', 'Graham', 'ethan.graham@example.com', '07801 123464', '1989-10-10', 'All', '2026-04-15'),
    (4, 10, 'Orla', 'McCarthy', 'orla.mccarthy@example.com', '07801 123465', '1996-07-12', 'SGPT', '2026-04-05');
...
INSERT INTO tblClass VALUES
    (3, 2, 1, 'SGPT', 'SGPT', '2023-03-01', '09:00:00', '10:00:00'),
    (2, 5, 2, 'HIIT', 'HIIT', '2023-03-02', '18:00:00', '19:00:00'),
    (4, 8, 3, 'Boxing', 'Boxing', '2023-03-03', '17:00:00', '18:00:00'),
    (5, 3, 4, 'Hyrox', 'Hyrox', '2023-03-04', '11:00:00', '12:30:00'),
    (1, 4, 5, 'SGPT', 'SGPT', '2023-03-05', '10:30:00', '11:30:00'),
    (2, 7,6, 'HIIT', 'HIIT', '2023-03-06', '19:30:00', '20:30:00'),
    (3, 1, 7, 'Boxing', 'Boxing', '2023-03-07', '16:00:00', '17:00:00'),
    (4, 6, 8, 'Hyrox', 'Hyrox', '2023-03-08', '12:00:00', '13:30:00'),
    (5, 2, 9, 'SGPT', 'SGPT', '2023-03-09', '08:00:00', '09:00:00'),
    (1, 3, 10, 'Boxing', 'Boxing', '2023-03-10', '17:30:00', '18:30:00');
